...
public abstract class R_AbstractModel {
	...
	protected void draw(int[] viewport, float[][] zBuffer, int width, int height, Mat4 viewProjMatrix, List<Light> lights, R_Player.Team side, R_Player.Team visible) {
		...
		// Finally draw object
		model.draw(viewport, zBuffer, width, height, viewProjMatrix.mul(modelMatrix), modelMatrix, lights, side, visible);
	}
}
